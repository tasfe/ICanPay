...
namespace ICanPay.Providers
{
    ...
    public sealed class TenpayGateway : GatewayBase, IPaymentUrl, IPaymentForm, IQueryNow
    {
        ...
        private void InitOrderParameter()
        {
            ...
            SetGatewayParameterValue("total_fee", Order.OrderAmount * 100);
        ...
        {
            if(Order.OrderAmount == Convert.ToDouble(GetGatewayParameterValue("total_fee")) * 0.01 &&
        ...
        {
            return string.Format("notify_id={0}&partner={1}", GetGatewayParameterValue("notify_id"), Merchant.Partner);
        }
        ...
        {
            return string.Format("out_trade_no={0}&partner={1}", Order.OrderNo, Merchant.Partner);
        }
