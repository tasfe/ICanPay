...
namespace com.unionpay.acp.sdk
{
    public static class SecurityUtil
    {
        ...
        /// <returns></returns>
        public static byte[] SignBySoft(AsymmetricKeyParameter key, byte[] data)
        {
            //byte[] res = null;
            //try
            //{
            ...
            //Array.Copy(dig, 0, block, data.Length, dig.Length);
            //Array.Copy(data, 0, block,
            //    data.Length + dig.Length, data.Length);
        ...
        /// <returns></returns>
        public static bool ValidateBySoft(AsymmetricKeyParameter key, byte[] base64DecodingSignStr, byte[] srcByte)
        {
            //HashAlgorithm hashalg = new SHA1CryptoServiceProvider();
